...
//=====     открытие и закрытие модальных окон.
    ...
    const soonModalBackground = document.querySelector(".coming-soon-bg");
    const soonModalClose = document.querySelector(".coming-soon-close");
    const soonModalBtns = document.querySelectorAll(".coming-soon-btn");

    for (let i = 0; i < soonModalBtns.length; i++) {
        soonModalBtns[i].addEventListener('click', function () {
            soonModalBackground.classList.remove('none');
        });

        soonModalClose.addEventListener("click", function () {
            soonModalBackground.classList.add('none');
        });
    }
